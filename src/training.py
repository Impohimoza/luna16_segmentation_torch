...
from .data.dataset import Luna2dSegmentationDataset, TrainingLuna2dSegmentationDataset, getCt
from .util.logconf import logging
from .models.unet import UNetWrapper
from .models.model import SegmentationAugmentation
...
class SegmentationTrainingApp:
    def __init__(self, sys_argv=None):
        ...
        parser.add_argument('--augment-flip',
                            help="Augment the training data by randomly \
                                flipping the data left-right, up-down, \
                                    and front-back.",
                            action='store_true',
                            default=False,)
        parser.add_argument('--augment-offset',
                            help="Augment the training data by \
                                randomly offsetting the data slightly \
        ...
        parser.add_argument('--augment-rotate',
                            help="Augment the training data by randomly \
                                rotating the data around the head-foot axis.",
                            action='store_true',
                            default=False,)
